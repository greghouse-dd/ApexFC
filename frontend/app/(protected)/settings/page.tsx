          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 w-full px-4 py-3.5 rounded-xl text-sm font-bold text-left transition duration-200 cursor-pointer border ${
                  active
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["⚽", "🏆", "🛡️", "🦁", "🦅", "⚡", "🔴", "🔵", "🟢", "⚔️", "👑", "🔥"].map((emoji) => (
                      <button
                        ...
                        className={`w-11 h-11 text-xl flex items-center justify-center rounded-xl cursor-pointer transition ${
                          clubEmoji === emoji 
                    ...
                    {COLOR_SCHEMES.map((scheme) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-3 p-3 rounded-xl border text-left cursor-pointer transition ${
                            active
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                    {VALID_FORMATIONS.map((f) => (
                      <button
                        ...
                        className={`py-3 px-4 rounded-xl border text-sm font-bold cursor-pointer transition ${
                          formation === f
