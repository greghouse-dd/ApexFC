...
export default function Home() {
  ...
  const featureAds = [
    ...
    },
    {
      ...
      description: "Build custom tactical lineups and calculate real-time squad chemistry synergies using our multi-vector cohesion algorithm.",
      statLabel: "Multi-Vector Chemistry Model",
      statValue: "7 Tactical Factors",
      icon: Users,
